...
```
127.0.0.1       Icecreamvsgelato.dev
```
...
```
<VirtualHost *>
    DocumentRoot "/path/to/Icecreamvsgelato/build/public/"
    ServerName Icecreamvsgelato.dev
    <Directory /path/to/Icecreamvsgelato/build/public/>
        AllowOverride All
        Order allow,deny
        Allow from all
    </Directory>
...
Visit [http://Icecreamvsgelato.dev/](http://Icecreamvsgelato.dev/) and you should see the home page. Check your browser's error console
